...
def account_creation_form_visible(driver_instance):
    elem = wait_for_invisibility_of_element(driver_instance, account_creation_form)
    return elem.is_displayed()


def radio_button_mr_selection(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, radio_button_mr)
    elem.click()


def radio_button_mrs_selection(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, radio_button_mrs)
    elem.click()


def correct_firstname1_submission(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, firstname_field1)
    elem.send_keys(firstname)


def correct_lastname1_submission(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, lastname_field1)
    elem.send_keys(lastname)


def correct_password_submission(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, password_field)
...
def checkbox_newsletter_selection(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, checkbox_newsletter)
    elem.click()


def checkbox_special_offers_selection(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, checkbox_special_offers)
    elem.click()


def correct_firstname2_submission(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, firstname_field2)
    elem.send_keys(firstname)


def correct_lastname2_submission(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, lastname_field2)
    elem.send_keys(lastname)


def correct_address1_submission(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, address_field1)
    elem.send_keys(street_address)


def correct_city_submission(driver_instance):
    elem = driver_instance.find_element_by_id(driver_instance, city_field)
    elem.send_keys(city)
